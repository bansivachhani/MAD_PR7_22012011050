package com.example.mad_pr7_22012011050
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recycler_view) // Assumes there's a RecyclerView withid `recycler_view` in activity_main.xml
    ...
    CoroutineScope(Dispatchers.IO).launch {
        try {
            val data = HttpRequest().makeServiceCall(
                "https://api.json-generator.com/templates/pW2BD7xs4RZ5/data",
                "d2rdtumjyl22i3cfu8xecm4za6mz2a3z0t0t6rlc"
            )
